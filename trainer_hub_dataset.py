...
# --- Bits and Bytes + LoRA ---
print("🔧 Setting up quantization and LoRA...")
...
trainer_checkpoint_path = f"{OUTPUT_DIR}/trainer_checkpoint"
best_checkpoint_path = f"{OUTPUT_DIR}/checkpoint-best"
...
print(f"🚀 Starting training with dataset from Hub: {DATASET_NAME}")
...
for epoch in range(start_epoch, num_epochs):
    ...
    for step, batch in progress:
        ...
        if global_step % save_steps == 0 and global_step > 0:
            ...
            os.makedirs(trainer_checkpoint_path, exist_ok=True)
            peft_model.save_pretrained(trainer_checkpoint_path)
            tokenizer.save_pretrained(trainer_checkpoint_path)
            ...
            with open(os.path.join(trainer_checkpoint_path, 'trainer_state.json'), 'w') as f:
                json.dump(trainer_state, f, indent=2)
        ...
        if global_step % eval_steps == 0:
            ...
            if eval_losses:
                ...
                if mean_eval_loss < best_eval_loss:
                    ...
                    peft_model.save_pretrained(best_checkpoint_path)
