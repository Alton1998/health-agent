...
def train_worker(rank, world_size, args):
    ...
    # --- Model Setup (Optimized for 16GB) ---
    if rank == 0:
        print("🤖 Loading model with 4-bit quantization...")
    
    # Optimized Bits and Bytes configuration for 16GB GPUs
    ...
    # --- Training Setup ---
    # Use 8-bit optimizer for memory savings
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Distributed Training Script (Hub Dataset)')
    
    # Model and data arguments
    parser.add_argument('--model_name', type=str, default='deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B',
                       help='Model name or path')
    parser.add_argument('--dataset_name', type=str, default='aldsouza/health-agent-dataset',
                       help='Dataset name from Hugging Face Hub')
    parser.add_argument('--output_dir', type=str, default='./health-agent-distributed-hub',
                       help='Output directory for checkpoints')
    
    # Training arguments (optimized for 16GB GPUs)
    parser.add_argument('--num_epochs', type=int, default=5,
                       help='Number of training epochs')
    parser.add_argument('--batch_size', type=int, default=1,
                       help='Batch size per GPU (recommended: 1 for 16GB)')
    ...
    # LoRA arguments (optimized for memory)
    ...
    parser.add_argument('--world_size', type=int, default=2,
                       help='Number of GPUs to use (default: 2 for 16GB setup)')
    ...
    print(f"🚀 Starting distributed training on {args.world_size} GPUs (Hub Dataset)")
    print(f"📊 Dataset: {args.dataset_name}")
